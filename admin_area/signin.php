...
<?php
  ...
  try {
      $conn = new PDO("mysql:host=$servername;dbname=rushdullah", $username, $password);
            ...
            <form action="" method="post">
                <legend>    
                        ...
                        <div class="form-control">
                            <label class="text-success h4">Username</label>
                            <input type="text" name="username" placeholder="Enter User Name" id="" class="form-control">
                        </div>        

                        <div class="form-control">
                            <label class="text-success h4">Password</label>
