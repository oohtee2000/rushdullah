...
if(isset($_POST['update_news']))
{
   ...
   // echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>fffff";
   ...
   // $_GET['id'];
    ...
    if(!$_FILES['news_pix1']['name'] == "") 
    {
      // echo "news1 is empty";
      $file = $_FILES['news_pix1'];
      $news->deleteFile($file);
    ...
    else
    {
     ...
     if(!$_FILES['news_pix2']['name'] == "")
     {
      // echo "news2 is empty";
      $file2 = $_FILES['news_pix2'];
       $news->deleteFile($file2);
    ...
    else
    {
     ...
     if(!$_FILES['news_pix3']['name'] == "")
     {
      // echo "news3 is empty";
      $file3 = $_FILES['news_pix3'];
        $news->deleteFile($file3);
    ...
    else
    {
      ...
      $update = $news->update_blog($id, $file, $file2, $file3, $news_title, $news_article, 5);


      if($update)
   {
      $_SESSION['update'] = "<h3 class='text-success'>News Updated Successfully</h3>";
     echo "<script>
   ...
   {
     $_SESSION['update_failed'] = "<h3 class='text-danger'>News Failed To Update</h3>";
      echo "<script>
    window.location.href = 'index.php';
   </script>";
   }
      ...
      <div class="container">
        ...
        <div class="faq-list">
            <form action="" method="post" enctype="multipart/form-data">
               ...
               $id = (int) $_GET['id'];
               // var_dump($id);
                $rows = $news->get_post($id, null, null);
                ...
                <fieldset>  
                  <legend>
                      <div class="form-control">
                            ...
                            <input type="text" name="news_title" placeholder="Enter News Title" id="" class="form-control" value="<?=$row['news_title'] ?>">
                      </div>
                  </legend>                    
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="news_article" class="form-control" id="editor1"><?=$row['news_article'] ?></textarea>
                        </div>                                      
                         ...
                         <div class="form-control">
                          <div class="row">
                            ...
                            <div class="col-2">
                              <img class="img-fluid" src="../assets/img/news/<?=$row['news_image'] ?>">
                            </div>
                          </div>
                        ...
                        <div class="form-control">
                          <div class="row">
                            ...
                            <div class="col-2">
                              <img class="img-fluid" src="../assets/img/news/<?=$row['news_image2'] ?>">
                            </div>
                          </div>
                        ...
                        <div class="form-control">
                          <div class="row">
                            ...
                            <div class="col-2">
                              <img class="img-fluid" src="../assets/img/news/<?=$row['news_image3'] ?>">
                            </div>
                          </div>
